...
/* Note: if remove "doorImage1.src=openDoor1" => game results run */
/* Note: if not include "doorImage1" as a playDoor() function's parameter, the game's logic is fault: when you open all doors, you win,
no matter if you open the bot door first or second */
